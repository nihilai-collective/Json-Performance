# Json-Performance
Here's a correctness validation comparing jsonifier's stage-1 parsing output to simdjson's on a few common operating system/compiler platforms. Cheers! (Click each of the badges below to be taken to the respective results). Also I will add some instructions for building below.
