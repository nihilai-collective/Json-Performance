...
param(
    ...
    [Parameter(Mandatory = $false)]
    [ValidateSet("main", "stage-1-parsing-main", "full-parsing-utf8-main", "correctness-validation-main", "scalar-vs-simd-main")]
    [string]$Branch,
...
if (-not $Branch) {
    ...
    $validBranches = @("main", "stage-1-parsing-main", "full-parsing-utf8-main", "correctness-validation-main", "scalar-vs-simd-main")
