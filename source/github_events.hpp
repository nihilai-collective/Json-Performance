...
template<> struct glz::meta<actor_data> {
	using value_type			= actor_data;
	static constexpr auto value = object(&value_type::gravatar_id, &value_type::login, &value_type::avatar_url, &value_type::url, &value_type::id);
};

template<> struct glz::meta<github_user> {
	using value_type			= github_user;
	static constexpr auto value = object(&value_type::url, &value_type::gists_url, &value_type::gravatar_id, &value_type::type, &value_type::avatar_url,
...
template<> struct glz::meta<comment_data> {
	using value_type = comment_data;
	static constexpr auto value =
		object(&value_type::user, &value_type::url, &value_type::issue_url, &value_type::created_at, &value_type::body, &value_type::updated_at, &value_type::id);
};

template<> struct glz::meta<author_data> {
	using value_type			= author_data;
	static constexpr auto value = object(&value_type::email, &value_type::name);
};

template<> struct glz::meta<commit> {
	using value_type			= commit;
	static constexpr auto value = object(&value_type::url, &value_type::message, &value_type::distinct, &value_type::sha, &value_type::author);
};

template<> struct glz::meta<label_data> {
	using value_type			= label_data;
	static constexpr auto value = object(&value_type::url, &value_type::name, &value_type::color);
};

template<> struct glz::meta<forkee_data> {
	using value_type			= forkee_data;
	static constexpr auto value = object(&value_type::description, &value_type::fork, &value_type::url, &value_type::language, &value_type::stargazers_url, &value_type::clone_url,
		&value_type::tags_url, &value_type::full_name, &value_type::merges_url, &value_type::forks, "private", &value_type::is_private, &value_type::git_refs_url,
		&value_type::archive_url, &value_type::collaborators_url, &value_type::owner, &value_type::languages_url, &value_type::trees_url, &value_type::labels_url,
		&value_type::html_url, &value_type::pushed_at, &value_type::created_at, &value_type::has_issues, &value_type::forks_url, &value_type::branches_url,
		...
		&value_type::assignees_url, &value_type::ssh_url, "public", &value_type::is_public, &value_type::has_wiki, &value_type::subscribers_url, &value_type::mirror_url,
		&value_type::watchers_count, &value_type::id, &value_type::has_downloads, &value_type::git_commits_url, &value_type::downloads_url, &value_type::pulls_url,
		&value_type::homepage, &value_type::issue_comment_url, &value_type::hooks_url, &value_type::subscription_url, &value_type::milestones_url, &value_type::svn_url,
		&value_type::events_url, &value_type::git_tags_url, &value_type::teams_url, &value_type::comments_url, &value_type::open_issues_count, &value_type::keys_url,
		&value_type::git_url, &value_type::contributors_url, &value_type::size, &value_type::watchers);
};

template<> struct glz::meta<pull_request_data> {
	using value_type			= pull_request_data;
	static constexpr auto value = object(&value_type::html_url, &value_type::patch_url, &value_type::diff_url);
};

template<> struct glz::meta<issue_data> {
	using value_type			= issue_data;
	static constexpr auto value = object(&value_type::user, &value_type::url, &value_type::labels, &value_type::html_url, &value_type::labels_url, &value_type::pull_request,
		&value_type::created_at, &value_type::closed_at, &value_type::milestone, &value_type::title, &value_type::body, &value_type::updated_at, &value_type::number,
		&value_type::state, &value_type::assignee, &value_type::id, &value_type::events_url, &value_type::comments_url, &value_type::comments);
};

template<> struct glz::meta<page> {
	using value_type			= page;
	static constexpr auto value = object(&value_type::page_name, &value_type::html_url, &value_type::title, &value_type::sha, &value_type::summary, &value_type::action);
};

template<> struct glz::meta<payload_data> {
	using value_type			= payload_data;
	static constexpr auto value = object(&value_type::commits, &value_type::distinct_size, &value_type::ref, &value_type::push_id, &value_type::head, &value_type::before,
...
template<> struct glz::meta<repo_data> {
	using value_type			= repo_data;
	static constexpr auto value = object(&value_type::url, &value_type::id, &value_type::name);
};

template<> struct glz::meta<github_event> {
	using value_type			= github_event;
	static constexpr auto value = object(&value_type::type, &value_type::created_at, &value_type::actor, &value_type::repo, "public", &value_type::is_public, &value_type::payload,
		&value_type::id, &value_type::org);
};
